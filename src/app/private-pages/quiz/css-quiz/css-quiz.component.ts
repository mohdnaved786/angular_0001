...
import { QUESTIONS_CSS } from '../../../quiz/question-data';
...
export class CssQuizComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.randomizedQuestions = this.shuffleArray(QUESTIONS_CSS.map(q => ({
      ...q,

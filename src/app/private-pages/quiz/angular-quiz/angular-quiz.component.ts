...
import { QUESTIONS_ANGULAR } from '../../../quiz/question-data';
...
export class AngularQuizComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.randomizedQuestions = this.shuffleArray(QUESTIONS_ANGULAR.map(q => ({
      ...q,

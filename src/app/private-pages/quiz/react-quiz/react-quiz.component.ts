...
import { QUESTIONS_REACT } from '../../../quiz/question-data';

@Component({
  selector: 'app-react-quiz',
  templateUrl: './react-quiz.component.html',
  styleUrls: ['./react-quiz.component.css']
})
export class ReactQuizComponent {
   ...
   currentQuestionIndex = 0;
    ...
    ngOnInit() {
      this.randomizedQuestions = this.shuffleArray(QUESTIONS_REACT.map(q => ({
        ...q,
